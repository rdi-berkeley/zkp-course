...
- For general course content related questions, please join our [edstem](https://edstem.org/us/courses/34475/discussion/) and [discord](https://discord.gg/z67NWXzFzj).
   ...
   <tbody>
      <tr>
        ...
        <td> Introduction and History of ZKP | 
          ...
          | <a href = "https://www.youtube.com/watch?v=uchjTIlPzFo"> Playlist </a>
      ...
      <tr>
         ...
         <td>Interactive Proofs (IP)
           ...
           | <a href = "{{site.baseurl}}/assets/lecture4.pdf"> Slides </a></td>
        <br>
        <br>
        <b>Readings</b>
            <ul>
